    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                <h4 class="mb-sm-0 font-size-18">Contact Responses</h4>

                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        <li class="breadcrumb-item"><a href="javascript: void(0);">Pages</a></li>
                        <li class="breadcrumb-item active">Contact Responses</li>
                    </ol>
                </div>
            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <div class="d-flex justify-content-between align-items-center">
                        <h4 class="card-title">Responses List</h4>
                        {{--                       @can('Create Admin')--}}
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">View Responses</h5>
                ...
                <div class="modal-body">
                    <form name="form2" id="editAdmin" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" id="eName" class="form-control" name="name" readonly>
                        </div>
                        <div class="mb-3">
                            <label for="eEmail" class="col-form-label">Email</label>
                            <input type="text" id="eEmail" class="form-control" name="email" readonly>
                        </div>
                        <div class="mb-3">
                            <label for="eMessage" class="col-form-label">Message</label>
                            <textarea id="eMessage" class="form-control" name="message" readonly></textarea>
