    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                <h4 class="mb-sm-0 font-size-18">Achievements</h4>
            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        {{--                       @if(Auth::guard('admin')->user()->can('Create Achievement'))--}}
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Create Achievement</h5>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form name="form2" id="editAdmin" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            <label for="ecount" class="col-form-label">Count</label>
                            <input type="number" class="form-control" id="ecount" name="count">
                        </div>
        ...
        $(document).ready(function () {
                ...
                $.ajax(
                    {
                        ...
                        url: "{{ url('admin/achievements') }}/" + id + "/edit",
                        data: {
                            id: id
                        },
            ...
            $(document).on('click', '#adminStatus', function () {
                ...
                $.ajax(
                    {
                        type: 'post',
                        url: "{{route('admin.achievement.status')}}",
                        data: {
                            '_token': token,
                            id: id,
                            status: status
